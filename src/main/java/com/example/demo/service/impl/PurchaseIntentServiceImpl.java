...
public class PurchaseIntentServiceImpl implements PurchaseIntentService {
    ...
    public PurchaseIntentServiceImpl(PurchaseIntentRecordRepository intentRepository, UserProfileRepository userRepository) {
    ...
    public PurchaseIntentRecord createIntent(PurchaseIntentRecord intent) {
        ...
        if (!userRepository.existsById(intent.getUserId()))
